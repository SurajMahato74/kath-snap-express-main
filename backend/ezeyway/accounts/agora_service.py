...
class AgoraTokenGenerator:
    ...
    def generate_channel_token(self, channel_name, uid, role=RtcRole.PUBLISHER, expire_sec=7200):
    ...
    def generate_rtc_token(self, channel_name, uid=0, role=1, expire_time=7200):
        ...
        agora_role = RtcRole.PUBLISHER if role == 1 else RtcRole.SUBSCRIBER
        return self.generate_channel_token(channel_name, uid, agora_role, expire_time)
