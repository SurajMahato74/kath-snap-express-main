...
urlpatterns = [
    ...
    path('orders/<int:order_id>/reviews/', order_views.get_order_reviews_api, name='get_order_reviews'),
    ...
    # Ship order endpoint
    path('vendor/orders/<int:order_id>/ship/', order_views.update_order_status_api, name='ship_order'),
]